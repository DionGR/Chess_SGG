...
public:
	void draw() override { graphics::drawRect(m_pos[0], m_pos[1], m_size[0], m_size[1], m_br); }
	...
	bool contains(float x, float y) const { return distance(x, y, m_pos[0], m_pos[1]) < SQUARE_HEIGHT/2.0f; }
};
