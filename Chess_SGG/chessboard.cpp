...
void Chessboard::init()
{
	...
	m_w_pieces.push_back(new Knight(Color::WHITE));
	m_w_pieces.push_back(new Bishop(Color::WHITE));
	...
	m_b_pieces.push_back(new Knight(Color::BLACK));
	m_b_pieces.push_back(new Bishop(Color::BLACK));
	...
	for (int i{ BOARD_HEIGHT - 1 }; i > BOARD_HEIGHT - 3; --i) {
